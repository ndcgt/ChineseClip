...
def parse_args():
    ...
    parser.add_argument(
        "--vision-model",
        choices=["ViT-B-32", "ViT-B-16", "ViT-L-14", "ViT-L-14-336", "ViT-H-14", "RN50", "self-trained"],
        default="ViT-B-16",
...
if __name__ == "__main__":
    ...
    args.resume='clip_cn_vit-b-16.pt'
    ...
    print(
        f"=> (epoch {checkpoint['epoch']} @ {checkpoint['step']} steps)"
    )
