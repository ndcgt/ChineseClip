...
def get_binding_idxs(engine: trt.ICudaEngine, profile_index: int):
    ...
    num_bindings_per_profile = num_bindings // engine.num_optimization_profiles
    ...
    for binding_index in range(start_binding, end_binding):
        ...
        try:
            ...
            # 假设存在 TensorIOMode 且有 INPUT 枚举值
            is_input = tensor_mode == trt.TensorIOMode.INPUT
        except AttributeError:
            raise AttributeError("无法找到合适的方法判断绑定是否为输入，请检查 TensorRT 版本。")
...
def get_output_tensors(
    ...
    for binding_index in output_binding_idxs:
        ...
        # output_shape = context.get_tensor_shape(binding=binding_index)
